...
<body>
    ...
    if (isset($_GET['id'])) {
        if ($_SESSION['id_role'] != 3) { ?>
            ...
            <?php }
        if ((in_array($_GET['id'], array_column($users, 'id_user')) && $_SESSION['id_user'] != 3) || ($_GET['id'] == $_SESSION['id_user'])) {
            if (count($oneUser) != 0) {
                $oneUser = $oneUser[0]; ?>
                <br>
                <form class="container" method="POST" action="#">
                    ...
                    <div class="container">
                        ...
                        <button type="button" class="btn btn-danger" data-backdrop="static" data-bs-toggle="modal" data-bs-target="#deleteUserModal">
